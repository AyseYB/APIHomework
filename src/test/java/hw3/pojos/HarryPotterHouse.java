...
public class HarryPotterHouse {
    ...
    public HarryPotterHouse(String id, String name, String mascot, String headOfHouse,
                            String houseGhost, String founder, Integer v, String school,
                            List<String> members, List<String> values, List<String> colors) {
        this.id = id;
        this.name = name;
        this.mascot = mascot;
